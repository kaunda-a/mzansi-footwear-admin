  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className="fixed z-[49] w-[16rem] max-w-[16rem] overflow-y-visible md:overflow-y-auto scrollbar-thin lg:relative border border-slate-300/60 dark:border-teal1/60 rounded-3xl m-3 h-[calc(100vh-1.5rem)] lg:m-4 lg:h-[calc(100vh-2rem)] transition-all duration-300 bg-white/100 dark:bg-zinc-900/100"
      >
